...
// 菜单列表
const menuItems = ref([
  {id:'5' , icon:'fa-brands fa-slack' , link:'/base/fileshow/project/index' , desc:'项目管理'},
  ...
  {id:'4' , icon:'fa-solid fa-code-pull-request' , link:'/base/fileshow/apiRecord/index' , desc:'请求记录'},
]);
